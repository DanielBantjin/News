...
@section('content')
    <div class="max-w-4xl mx-auto p-6 rounded-lg shadow-md mt-20"
        ...
        <form method="POST" action="{{ route('articles.store') }}" enctype="multipart/form-data">
            ...
            <!-- Judul -->
            <div class="mb-4">
                <label for="title" class="block text-sm font-medium mb-1" style="color: var(--text-secondary);">Judul
                    Artikel</label>
            ...
            <div class="mb-4">
                <label for="content" class="block text-sm font-medium mb-1"
                    style="color: var(--text-secondary);">Konten</label>
            ...
            <div class="mb-4">
                <label for="tags" class="block text-sm font-medium mb-1"
                    style="color: var(--text-secondary);">Tag</label>
            ...
            <!-- Gambar -->
            <div class="mb-4">
                <label for="image" class="block text-sm font-medium mb-1" style="color: var(--text-secondary);">Unggah
                    Gambar</label>
            ...
            <!-- Tombol Simpan -->
            <button type="submit" class="px-4 py-2 rounded-md transition duration-300 hover:shadow-md"
