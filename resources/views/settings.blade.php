...
<div class="container mx-auto p-8 max-w-lg" 
    ...
    <h2 class="text-4xl font-extrabold mb-6 border-b-4 pb-3" 
        style="border-color: var(--text-link);">⚙️ Settings</h2>
    ...
    <form action="{{ route('settings.changePassword') }}" method="POST" class="space-y-8">
        ...
        <div>
            <label for="current_password" 
                   ...
                   class="block text-sm font-medium mb-2">🔑 Current Password</label>
        ...
        <div>
            <label for="new_password" 
                   style="color: var(--text-secondary);" 
                   class="block text-sm font-medium mb-2">🔑 New Password</label>
        ...
        <div>
            <label for="new_password_confirmation" 
                   style="color: var(--text-secondary);" 
                   class="block text-sm font-medium mb-2">🔑 Confirm New Password</label>
